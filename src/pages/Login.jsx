...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault()
      ...
      signInWithEmailAndPassword(auth, email.value, password.value).then((res)=> console.log(res))
  }
  return (
    <div className="max-w-screen-xl mx-auto w-full h-[calc(100vh-120px)] flex items-center justify-center flex-col">
      ...
      <form className="flex flex-col p-2 space-y-2 border-4 rounded-lg w-72" onSubmit={handleLogin}>
        <input
          id="email"
          type="email"
